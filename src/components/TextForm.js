...
export default function TextForm(props) {
  ...
  return (
    ...
    <div className='container' style={{ color: props.mode==='dark' ? 'white':'black' }}>
      ...
      <button className="btn btn-primary mx-1" onClick={handleUpClick}>Converted to Uppercase</button>
      <button className="btn btn-primary mx-1" onClick={handleDowClick}>Converted to Lawercase</button>
